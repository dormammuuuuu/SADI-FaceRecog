...
if __name__ == "__main__":
    ...
    # classifier = train("sample_gal/train", model_save_path="test_anjo_gelo_lappay_sha.clf", n_neighbors=4)
    ...
    for image_file in os.listdir("dataset/test"):
        ...
        predictions = predict(full_file_path, model_path="test_anjo_gelo_lappay_sha_v2.clf")
