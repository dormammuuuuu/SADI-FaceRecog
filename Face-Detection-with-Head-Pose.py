    ...
    def findFaces(self, img, start_time, counter, draw=True):
        ...
        if results.multi_face_landmarks:
            for face_landmarks in results.multi_face_landmarks:
                ...
                # cv.putText(image, text, (470, 50), cv.FONT_HERSHEY_PLAIN, 2, (255, 0, 255), 2)
...
def main():
    ...
    while True:
        ...
        cv.imshow("Register Face", img)

        if cv.waitKey(1) == 13 or int(img_id) == 500:
            break
